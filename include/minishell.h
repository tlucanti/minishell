...
int			set_autoattr(int desc, int value, int what) __attribute__((
					__nothrow__));
void		putsfd(int fd, const char *__restrict str) __attribute__((
					__nothrow__));

int			builtin_echo(char *const *__restrict argv) __attribute__((
					warn_unused_result)) __attribute__((__nothrow__));
int			builtin_cd(char *__restrict const *__restrict argv) __attribute__((
					warn_unused_result)) __attribute__((__nothrow__));
int			builtin_pwd(char *__restrict const *__restrict argv) __attribute__((
					warn_unused_result)) __attribute__((__nothrow__));
int			builtin_export(char *const *__restrict argv) __attribute__((
					warn_unused_result)) __attribute__((__nothrow__));
int			builtin_export_split(const char *__restrict string,
				char *__restrict *__restrict key,
				char *__restrict *__restrict value) __attribute__((
					__nothrow__));
int			builtin_unset(char *__restrict const *__restrict argv
				) __attribute__((warn_unused_result)) __attribute__((
					__nothrow__));
int			builtin_env(char *__restrict const *__restrict argv) __attribute__((
					warn_unused_result)) __attribute__((__nothrow__));
int			builtin_exit(char *__restrict const *__restrict argv) __attribute__(
				(warn_unused_result)) __attribute__((__nothrow__));
int			builtin_execve(char *const *__restrict argv) __attribute__((
					warn_unused_result)) __attribute__((__nothrow__));
char		*builtin_heredoc(const char *__restrict end) __attribute__((
					warn_unused_result)) __attribute__((__nothrow__));

int			exit_status_storage(int status, int set) __attribute__((
					__nothrow__));
