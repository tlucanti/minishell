...
/*   Updated: 2021/10/27 11:24:06 by kostya           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*__restrict *clear_split_smart(char *__restrict *__restrict array) __attribute__((
				__nothrow__));
void	enforce_env(char *__restrict *__restrict array) __attribute__((__nothrow__));
...
char	*builtin_heredoc_prompt(int reset) __attribute__((
				warn_unused_result)) __attribute__((__nothrow__));
char	*__restrict *implement_redirect(char *__restrict *__restrict ptr, int _in_out[2]
			) __attribute__((warn_unused_result)) __attribute__((__nothrow__));
int		implement_heredoc(const char *__restrict end) __attribute__((
				warn_unused_result)) __attribute__((__nothrow__));
char	*__restrict *redirect_shard(char *__restrict *__restrict ptr, uint *__restrict argv_size,
...
int		backup_fd_in_out(int _in_out[2], int init) __attribute__((__nothrow__));
